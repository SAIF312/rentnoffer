    ...
    <div id="content" class="main-content">
        <div class="layout-px-spacing">
            ...
            <div class="row layout-top-spacing">
                <div class="col-12">
                    <a type="button" href="{{ route('add_category') }}" class="btn btn-dark float-right ms-auto mb-2">Add
                        Category</a>
                </div>
                ...
                <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                    <div class="widget-content widget-content-area br-6">
                        ...
                        <table id="categories_table" class="table table-hover non-hover" style="width:100%">
    ...
    <script>
        function DisableCategory(id) {
            swal.fire({
                ...
                text: "User will not be able to see any products under this category",
                type: "warning",
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: "GET",
                        url: '{{ url('category_disable') }}/' + id,

                        success: function(data) {
                            $('#categories_table').DataTable().ajax.reload();
                            swal.fire("Success", " Category disabled successfully", "success");
                        },
        ...
        function ActiveCategory(id) {
            swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: "GET",
                        url: '{{ url('category_active') }}/' + id,

                        success: function(data) {
                            $('#categories_table').DataTable().ajax.reload();
                            swal.fire("Success", " Category Activated successfully", "success");
                        },
                        error: function(error) {
                            Snackbar.show({
                                text: 'Somthing Went Wrong',
        ...
        function DeleteCategory(id) {
            swal.fire({
                ...
                text: "All products under this category will automatically delete",
                type: "warning",
                showCancelButton: true,
                confirmButtonColor: "#DD6B55",
