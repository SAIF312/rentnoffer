...
@push('end-script')
    ...
    <script>
        $('#products_table').DataTable({
            ...
            ajax: "{{ route('products.deactivated') }}",
            columns: [{
                    data: 'DT_RowIndex',
                    name: 'DT_RowIndex'
                },
...
@section('content')
    ...
    <script>
        ...
        function ActiveProduct(id) {
            swal.fire({
                title: "Are you sure to Activate this Product?",
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        ...
                        success: function(data) {
                            $('#products_table').DataTable().ajax.reload();
                            swal.fire("Success", " Product Activate successfully", "success");
                        },
                        error: function(error) {
                            Snackbar.show({
                                text: 'Somthing Went Wrong',
