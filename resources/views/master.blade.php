...
<head>
    ...
    <title>@yield('title') | Rent n Offer </title>
...
<body>
        ...
        <header class="header navbar navbar-expand-sm">
            ...
            <ul class="navbar-item theme-brand flex-row  text-center">
                ...
                <li class="nav-item theme-text">
                    <a href="{{ Url('/dashboard') }}" class="nav-link"> Rent n Offer </a>
                </li>
            </ul>
                        ...
                        <div class="">
                            ...
                            <a class="dropdown-item">
                                <div class="">
                                    <div class="media">
                                        <div class="user-img">
                                            <img src="{{ asset('assets/assets/img/90x90.jpg') }}"
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    <li class="menu">
                        <a href="{{ route('dashboard') }}" aria-expanded="false" class="dropdown-toggle"
                            data-active="{{ Request::is('dashboard') ? 'true' : 'false' }}">
                            <div class="">
                                <i class="fa fa-home custom-icons" aria-hidden="true"></i>
                                <span>Dashboard</span>
                            </div>
                        </a>
                    </li>
                    ...
                    <li class="menu">
                        <a href="{{ route('pages.index') }}" aria-expanded="false" class="dropdown-toggle"
                            data-active="{{ (Request::is('pages') || Request::is('pages/*')) ? 'true' : 'false' }}">
                            <div class="">
                                {{-- <i class="fa fa-user custom-icons" aria-hidden="true"></i> --}}
                                <i class="fa fa-files-o custom-icons" aria-hidden="true"></i>
                                <span>Pages</span>
                            </div>
                        </a>
                    </li>
                    ...
                    <li class="menu">
                        <a href="{{ route('categories') }}" aria-expanded="false" class="dropdown-toggle"
                            data-active="{{ Request::is('categories') || Request::is('categories/*') ? 'true' : 'false' }}">
                            <div class="">
                                <i class="fa fa-th custom-icons" aria-hidden="true"></i>
                                <span>Categories</span>
                            </div>
                        </a>
                    </li>
                    <li class="menu">
                        <a href="{{ route('attribute_group') }}" aria-expanded="false" class="dropdown-toggle"
                            data-active="{{ Request::is('attributes') || Request::is('attributes/*') ? 'true' : 'false' }}">
                            <div class="">
                                <i class="fa fa-asterisk custom-icons" aria-hidden="true"></i>
                                <span>Attribute</span>
                            </div>
                        </a>
                    </li>
                    <li class="menu">
                        <a href="#dashboard" data-active="{{ Request::is('*/products') ? 'true' : 'false' }}"
                            data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                                <i class="fa-brands fa-product-hunt custom-icons"></i>
                                <span>Products</span>
                            </div>
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                        ...
                        <ul class="collapse submenu list-unstyled {{ Request::is('*/products') ? 'show' : '' }}" id="dashboard"
                            data-parent="#accordionExample">
                            <li class="{{ Request::is('approved/*') ? 'active' : '' }}">
                                <a href="{{ route('approved_index') }}"> Activated </a>
                            </li>
                            <li class="{{ Request::is('disabled/*') ? 'active' : '' }}">
                                <a href="{{ route('disabled_index') }}"> Deactivated </a>
                            </li>
                            <li class="{{ Request::is('rejected/*') ? 'active' : '' }}">
                                <a href="{{ route('rejected_index') }}"> Rejected </a>
                            </li>
                            <li class="{{ Request::is('pending/*') ? 'active' : '' }}">
                                <a href="{{ route('pending_index') }}"> Pending </a>
                            </li>
                        </ul>
                    </li>
                    <li class="menu">
                        <a href="{{ route('invoices_index') }}" aria-expanded="false" class="dropdown-toggle"
                            data-active="{{ Request::is('invoices/index') ? 'true' : 'false' }}">
                            <div class="">
                                <i class="fa-solid fa-money-bill-transfer  custom-icons" aria-hidden="true"></i>
                    ...
                    <li class="menu">
                        <a href="{{ route('orders.index') }}" aria-expanded="false" class="dropdown-toggle"
                            data-active="{{ (Request::is('orders') || Request::is('orders/*')) ? 'true' : 'false' }}">
                            <div class="">
                    ...
                    <li class="menu">
                        <a href="{{ route('reports.index') }}" aria-expanded="false" class="dropdown-toggle"
                            data-active="{{ (Request::is('reports') || Request::is('reports/*')) ? 'true' : 'false' }}">
                            <div class="">
                                <i class="fa fa-key custom-icons" aria-hidden="true"></i>
                                <span>Reports</span>
                            </div>
                        </a>
                    </li>
                    ...
                    <li class="menu">
                        <a href="{{ route('users') }}" aria-expanded="false" class="dropdown-toggle"
                            data-active="{{ Request::is('users') || Request::is('users/*') ? 'true' : 'false' }}">
                            <div class="">
                                <i class="fa fa-users custom-icons" aria-hidden="true"></i>
                                <span>Users</span>
                            </div>
                        </a>
                    </li>
                    ...
                    <li class="menu">
                        <a href="{{ route('roles.index') }}" aria-expanded="false" class="dropdown-toggle"
                            data-active="{{ (Request::is('roles') || Request::is('roles/*')) ? 'true' : 'false' }}">
                            <div class="">
                                <i class="fa fa-circle-o-notch custom-icons" aria-hidden="true"></i>
                                <span>Roles</span>
                            </div>
                        </a>
                    </li>
                    ...
                    <li class="menu">
                        <a href="{{ route('settings.index') }}" aria-expanded="false" class="dropdown-toggle"
                            data-active="{{ (Request::is('settings') || Request::is('settings/*')) ? 'true' : 'false' }}">
                            <div class="">
                                <i class="fa fa-gear custom-icons" aria-hidden="true"></i>
                                <span>Settings</span>
                            </div>
                        </a>
                    </li>
    ...
    <script src="{{ asset('assets/bootstrap/js/popper.mins.js') }}"></script>
